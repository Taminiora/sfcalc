...
function createPresetStarforceProfile({
  ...
  return createDefaultStarforceProfile({
    ...
    percentileCosts: withCostCacheVersion({
      ...(isAstraSecondary ? { astraCostModelVersion: ASTRA_COST_MODEL_VERSION, boomBudgetProbability } : {}),
      p50Cost,
      p75Cost,
      pTargetCost,
      p95Cost,
...
export const DEFAULT_PROFILE_INPUTS = Object.freeze([
  createPresetStarforceProfile({
    ...
    p50CostB: 4.9665854,
    p75CostB: 31.8269904,
    pTargetCostB: 51.6848753,
    p95CostB: 94.3924148,
    expectedBooms: 5.052597937459766,
    p50Booms: 1,
    p75Booms: 7,
    p95Booms: 22,
    achievedProbability: 0.8500000746204304,
    boomBudgetProbability: 0.8581833263552916,
    requiredSpares: 12,
    requiredBooms: 12,
  }),
  createPresetStarforceProfile({
  ...
  createPresetStarforceProfile({
    ...
    targetStar: 24,
    isAstraSecondary: true,
    costB: 51.50564690348353,
    expectedTotalCostB: 66.88627648930598,
    p50CostB: 24.9692409,
    p75CostB: 97.8386284,
    pTargetCostB: 151.5409195,
    p95CostB: 267.0363637,
    expectedBooms: 15.380629585822458,
    p50Booms: 5,
    p75Booms: 23,
    p95Booms: 62,
    achievedProbability: 0.8500000819972378,
    boomBudgetProbability: 0.8523541490300688,
    requiredSpares: 35,
    requiredBooms: 35,
  }),
  createPresetStarforceProfile({
  ...
  createPresetStarforceProfile({
    ...
    targetStar: 25,
    isAstraSecondary: true,
    costB: 139.4760697198983,
    expectedTotalCostB: 181.07701069488476,
    p50CostB: 67.4762922,
    p75CostB: 265.4282152,
    pTargetCostB: 411.3120319,
    p95CostB: 725.0585195,
    expectedBooms: 41.60094097498645,
    p50Booms: 15,
    p75Booms: 61,
    p95Booms: 168,
    achievedProbability: 0.850000111576785,
    boomBudgetProbability: 0.851480370804026,
    requiredSpares: 95,
    requiredBooms: 95,
  }),
  createPresetCubingProfile({
  ...
  createPresetStarforceProfile({
    ...
    p50CostB: 181.5157836,
    p75CostB: 718.6144032,
    pTargetCostB: 1114.4371777,
    p95CostB: 1965.7188388,
    expectedBooms: 112.52064035139193,
    p50Booms: 41,
    p75Booms: 165,
    p95Booms: 453,
    achievedProbability: 0.8500000384670598,
    boomBudgetProbability: 0.8501051329033767,
    requiredSpares: 256,
    requiredBooms: 256,
  }),
  createPresetStarforceProfile({
...
function hasFreshStarforceCostSnapshot(profile) {
  ...
  return (
    (isAstraSecondarySource(profile.source)
      ? costs.astraCostModelVersion === ASTRA_COST_MODEL_VERSION
